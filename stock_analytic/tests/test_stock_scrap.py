...
class TestStockScrap(TransactionCase):
    ...
    def _create_scrap(self, analytic_account_id=False):
        scrap_data = {
            ...
            'analytic_account_id':
                analytic_account_id and analytic_account_id.id or False
        }
    ...
    def _check_analytic_account_no_error(self, scrap):
        ...
        for acc_line in acc_lines:
            if acc_line.account_id != scrap.product_id.categ_id.\
                    property_stock_valuation_account_id:
                self.assertEqual(acc_line.analytic_account_id.id,
                                 scrap.analytic_account_id.id)
